...
Fullstack -kurssin blogilista backend ja UT -tehtävien 4.1 - 4.4 palautus
...
- Apufunktioita ja yksikkötestejä, stepit 1-2 (tehtävät 4.3-4.4),
  dummytesti ja total_likes - testit sekä funktiot
