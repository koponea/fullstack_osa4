...
Fullstack -kurssin blogilista backend ja UT -tehtävien 4.1 - 4.18 palautus...
...
- __4c-d__: Blogilistan laajennus: stepit 3-6 (tehtävät 4.14-4.18). Käyttäjien tietokanta, POST ja GET, kredentiaalien validointi sekä testit. Populointi molemmin puolin käyttäjä-blogi välillä. Tokenperustainen autentikointi (steppi 6).
